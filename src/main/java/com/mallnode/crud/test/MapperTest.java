package com.mallnode.crud.test;


import com.mallnode.crud.bean.Department;
import com.mallnode.crud.bean.Employee;
import com.mallnode.crud.dao.DepartmentMapper;
import com.mallnode.crud.dao.EmployeeMapper;
...
//		}
		EmployeeMapper mapper = sqlSession.getMapper(EmployeeMapper.class);	//可以批量的sqlsession
